...
const MinesGame = require('../models/games/mines/minesbet');
...
const ADMIN_EMAIL = 'admin@wager.com';
    ...
    getUserDetails: async (req, res) => {
        try {
            ...
            const [
                ...
                MinesGame.countDocuments({ user_id: userId }),
                // Financial data
            ...
            const response = {
                ...
                referral_code: profile.affiliateCode,
                ...
                // Games Models Data
                total_bets: diceGames + crashGames + hiloGames + plinkoGames + minesGames,
                games_breakdown: {
                    dice_bets: diceGames,
                    crash_bets: crashGames,
                    hilo_bets: hiloGames,
                    plinko_bets: plinkoGames,
                    mines_bets: minesGames
                },
        ...
        try {
            ...
            const updatedProfile = await Profile.findByIdAndUpdate(
                 userId ,
                {
                    ...
                    affiliateCode: updateData.referral_code,
