        ...
        if (type === 'DirectDeposit') {                                                                                                                                                     
            ...
            if (depositDetails.success) {
                ...
                if (referenceIdParts.length >= 2) {
                    console.log(" referenceId parts passed " + referenceIdParts)
                    ...
                    if (permanentAddress) {
                        ...
                        // if (!existingDeposit) {
                            ...
                            if (status === 'Success') {
                                ...
                                await CCPaymentDeposit.updateOne({ user_id: permanentAddress.user_id, orderId: `perm_${recordId}`,},{
                                ...
                                if (!isFlaggedAsRisky) {
                                    ...
                                    console.log("Is flaggedAsRisky isn't risky, and the walletCurrent => " + walletCurrency)
                        ...
                        // }
                        // else{
                        //     console.log("existingDeposit already exist")
                        // }
                    } else {
